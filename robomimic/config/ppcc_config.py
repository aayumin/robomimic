...
class PPCCConfig(BaseConfig):
    ...
    def train_config(self):
        ...
        """
        super(PPCCConfig, self).train_config()
    ...
    def algo_config(self):
        ...
        # action encoder
        self.algo.ppcc.action_embed_dim = 512
        self.algo.ppcc.action_hidden_dims = [512, 512]
        self.algo.ppcc.action_activation = "relu"
        self.algo.ppcc.action_dropout = 0.0
        self.algo.ppcc.action_layer_norm = True

        # projection heads for contrastive learning
        self.algo.ppcc.contrast_dim = 128
        self.algo.ppcc.proj_hidden_dim = 256
        self.algo.ppcc.proj_activation = "relu"
        self.algo.ppcc.proj_layer_norm = True
        self.algo.ppcc.normalize_projection = True
