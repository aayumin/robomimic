...
import robomimic.models.papc_nets as PAPCNets
...
@register_algo_factory_func("papc")
...
class PAPCPolicy(PolicyAlgo):
    ...
    def log_info(self, info):
        ...
        """
        log = super(PAPCPolicy, self).log_info(info)
