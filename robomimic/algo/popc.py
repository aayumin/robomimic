...
@register_algo_factory_func("popc")
...
class POPCPolicy(PolicyAlgo):
    def _create_networks(self):
        ...
        noise_pred_net = POPCNets.ConditionalUnet1D(
    ...
    def train_on_batch(self, batch, epoch, validate=False):
        ...
        with TorchUtils.maybe_no_grad(no_grad=validate):
            info = super(POPCPolicy, self).train_on_batch(batch, epoch, validate=validate)
    ...
    def log_info(self, info):
        ...
        """
        log = super(POPCPolicy, self).log_info(info)
